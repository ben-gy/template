Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = (ENV['ACTIONCABLE_CORS_ALTS'] || "").split(",")
  ...
  # config.active_job.queue_name_prefix = "redial_production"
